...
#define IDA_TITLE		"INYTEL Messenger"
#ifdef Q_OS_WIN
...
#define IDA_DESCRIPTION	"INYTEL Messenger is a free peer-to-peer messaging application for intra-network communication "\
						"and does not require a server.\n"\
						"INYTEL Messenger works on essentially every popular desktop platform.\n\n"\
						"Built on the open-source LAN Messenger project, modernized and rebranded by INYTEL."
#define IDA_COPYRIGHT	"Copyright (C) 2010-2016 Qualia Digital Solutions.\nINYTEL modernization and rebrand (C) 2026."
#define IDA_CONTACT		"lanmsngr@gmail.com"
#define IDA_DOMAIN		"https://github.com/alitfal/inytel-lanmessenger"
