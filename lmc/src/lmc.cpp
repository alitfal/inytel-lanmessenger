...
void lmcCore::init(const QString& szCommandArgs) {
	...
	//	remove duplicates
	{ QSet<QString> uniqueSet(arguments.begin(), arguments.end()); arguments = QStringList(uniqueSet.begin(), uniqueSet.end()); }
...
bool lmcCore::receiveAppMessage(const QString& szMessage) {
	...
	//	remove duplicates
	{ QSet<QString> uniqueSet(messageList.begin(), messageList.end()); messageList = QStringList(uniqueSet.begin(), uniqueSet.end()); }
