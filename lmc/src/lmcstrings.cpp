...
const QString lmcStrings::appName(void) {
	if(m_appName.isEmpty())
		m_appName = tr("INYTEL Messenger");
	return m_appName;
}

const QString lmcStrings::appDesc(void) {
	if(m_appDesc.isEmpty())
        m_appDesc = tr("INYTEL Messenger is a free peer-to-peer messaging application for\n"\
                       ...
                       "Built on the open-source LAN Messenger project, modernized and\n"\
                       "rebranded by INYTEL.");
	return m_appDesc;
}
