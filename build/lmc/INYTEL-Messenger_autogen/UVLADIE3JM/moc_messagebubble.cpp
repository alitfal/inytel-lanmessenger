...
#include "../../../../lmc/src/messagebubble.h"
...
void MessageBubble::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MessageBubble::*)(const QString & )>(_a, &MessageBubble::linkHovered, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MessageBubble::*)(const QString & )>(_a, &MessageBubble::linkActivated, 1))
            return;
    }
}
...
// SIGNAL 0
void MessageBubble::linkHovered(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void MessageBubble::linkActivated(const QString & _t1)
{
